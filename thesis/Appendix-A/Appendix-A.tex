...
\section{Temperature Jacobian Formulation and Non-dimensionalization}
\label{temperature-jacobian-conditioning}

TODO: Describe the temperature jacobian, and how it's condition number scales
quadratically with the freestream velocity.
