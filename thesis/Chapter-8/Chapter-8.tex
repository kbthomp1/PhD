...
\end{table}
%------------------------------------------------------------------------------%
\tref{tab:srp-frozen-flow-diff} shows that the decoupled and fully coupled
...
digit of both quantities in \tref{tab:srp-frozen-flow-diff} were changing by the
end of the solution.
%------------------------------------------------------------------------------%
\begin{table}
  \centering
...
\end{table}
%------------------------------------------------------------------------------%
\tref{tab:srp-chem-flow-diff} shows similar agreement with regard to the plenum
mass flow rate, but poorer agreement of the surface temperature. Given the
varying degrees of convergence shown in \fref{fig:chem-res-comp}, this
