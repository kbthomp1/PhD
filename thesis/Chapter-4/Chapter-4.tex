...
\end{equation}
%------------------------------------------------------------------------------%
details and the derivation of the transformation matrices need to convert
...
\end{equation}
%------------------------------------------------------------------------------%
In addition to \erefs{dfdvl}{dfdvr}, the iterative mechanism used in the solver
...
least-squares.  For the example 2-D stencil shown in \fref{fig:lsq-gradients}
...
\sref{sec:2nd-order-reconstruction}, and it significantly decreases the
