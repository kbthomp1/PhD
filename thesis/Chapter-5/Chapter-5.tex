...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.5\textwidth]{figures/surface2.png}
...
\fref{fig:plenum-face}.  The mass fractions for species leaving the plenum can
also be specified as a design variable.

\begin{figure}[h]
  \centering
  \includegraphics[width=0.5\textwidth]{figures/plenum_bc.png}
