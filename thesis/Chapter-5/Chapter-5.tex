...
A particular difficulty of this approach comes from misaligned meshes involving
...
function is to revisit the Van Albada flux limiter.  \fref{fig:vl-va-impact}
