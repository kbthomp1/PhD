...
conditions in \tref{tab:flow-conditions} and the plenum conditions in
...
A particular difficulty of this approach comes from mis-aligned meshes involving
...
equations with chemistry is marred by a high degree of sensitivity to the flux
limiter used.  It can be seen in \fref{fig:chem-res-comp} that convergence to
...
\fref{fig:vl-va-impact} also shows that if $\varepsilon$ is tuned to a value of
